...
class Srv6InsertTest(P4RuntimeTest):
    ...
    def testPacket(self, pkt, sid_list, next_hop_mac):
        ...
        # Add entry to "Station_table" table. Consider the given pkt's eth dst addr
        # as myStationMac address.
        self.insert(self.helper.build_table_entry(
            table_name="IngressPipeImpl.L2_station_table",
            match_fields={
                # Exact match.
...
class Srv6EndPspTest(P4RuntimeTest):
    ...
    def testPacket(self, pkt, sid_list, next_hop_mac, my_sid):
        ...
        # Add entry to "L2_station" table. Consider the given pkt's eth dst addr
        # as myStationMac address.
        self.insert(self.helper.build_table_entry(
            table_name="IngressPipeImpl.L2_station_table",
            match_fields={
